...
public:
     ...
     * check does nothing.
     */
    void check() const EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
    ...
    /** Remove all transactions in txToRemove and their descendants. */
    void removeForReorg(const setEntries& txToRemove) EXCLUSIVE_LOCKS_REQUIRED(cs, cs_main);
