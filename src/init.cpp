...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-packagerelay", strprintf("[EXPERIMENTAL] Support relaying transaction packages (default: %u)", DEFAULT_ENABLE_PACKAGE_RELAY), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
...
bool AppInitMain(NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    const bool enable_package_relay{gArgs.GetBoolArg("-packagerelay", DEFAULT_ENABLE_PACKAGE_RELAY)};
