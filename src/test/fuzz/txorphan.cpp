            ...
            CallOneOf(
                ...
                [&] {
                    ...
                    // tx weight is unknown, we only check when tx is already in orphanage
                    {
                        ...
                        if (add_tx) {
                            ...
                            // If announcement was added, total bytes should not have changed.
                ...
                [&] {
                    ...
                    // AddAnnouncer should return false if tx doesn't exist or we already HaveTxFromPeer.
                    {
                        ...
                        // Total bytes should not have changed.
                        // The orphanage may trim itself, so the peer's usage may have gone up or down.
                        Assert(orphanage->TotalOrphanUsage() == total_bytes_start);
                    }
                },
                [&] {
