    ...
    LIMITED_WHILE(fuzzed_data_provider.ConsumeBool(), 10000)
    {
        ...
        CallOneOf(
            ...
            [&] {
                ...
                txdownloadman.MempoolRejectedTx(rand_tx, state);
            },
            [&] {
            ...
            [&] {
                const auto res = txdownloadman.MaybeAddNewOrphan(rand_tx, rand_peer);
                if (res.second) {
    ...
    LIMITED_WHILE(fuzzed_data_provider.ConsumeBool(), 10000)
    {
        ...
        CallOneOf(
            ...
            [&] {
                ...
                Assert(!txdownload_impl.m_orphanage.HaveTx(GenTxid::Wtxid(rand_tx->GetWitnessHash())));
            },
            [&] {
            ...
            [&] {
                TxValidationState state;
                state.Invalid(fuzzed_data_provider.PickValueInArray(TESTED_TX_RESULTS), "");
                txdownload_impl.MempoolRejectedTx(rand_tx, state);
            },
            [&] {
                GenTxid gtxid = fuzzed_data_provider.ConsumeBool() ?
                                GenTxid::Txid(rand_tx->GetHash()) :
            ...
            [&] {
                ...
                if (maybe_package.has_value()) {
                    ...
                    Assert(txdownload_impl.m_recent_rejects_reconsiderable.contains(rand_tx->GetWitnessHash().ToUint256()));
                    Assert(txdownload_impl.m_orphanage.HaveTx(GenTxid::Wtxid(maybe_package->m_txns.back()->GetWitnessHash())));
            ...
            [&] {
                const auto res = txdownload_impl.MaybeAddNewOrphan(rand_tx, rand_peer);
                if (res.second) {
            ...
            [&] {
                ...
                if (ptx) {
                    ...
                    txdownload_impl.MempoolRejectedTx(ptx, state_missing_inputs);
                }
            }
        );
