...
BOOST_AUTO_TEST_CASE(MempoolIndexingTest)
{
    ...
    BOOST_CHECK(pool.CalculateMemPoolAncestors(std::vector<CTxMemPoolEntry>{entry.Fee(2000000LL).FromTx(tx7)}, setAncestorsCalculated, 100, 1000000, 1000, 1000000, dummy));
    BOOST_CHECK(setAncestorsCalculated == setAncestors);
    ...
    BOOST_CHECK(setAncestorsCalculated == setAncestors);
    setAncestorsCalculated.clear();
    BOOST_CHECK(pool.CalculateMemPoolAncestors(std::vector<CTxMemPoolEntry>{entry.Fee(200000LL).Time(4).FromTx(tx10)}, setAncestorsCalculated, 100, 1000000, 1000, 1000000, dummy));
    BOOST_CHECK(setAncestorsCalculated == setAncestors);
