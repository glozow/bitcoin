...
BOOST_FIXTURE_TEST_CASE(version3_tests, RegTestingSetup)
{
    ...
    many_inputs.emplace_back(mempool_tx_v3->GetHash(), 0);
    {
        ...
        struct_child_big.ancestor_counts.resize(package_child_big.size());
    ...
    script_multisig << OP_2 << OP_CHECKMULTISIG;
    {
        ...
        BOOST_CHECK_EQUAL(*ApplyV3Rules(tx_many_sigops, *ancestors, empty_conflicts_set,
        ...
        PackageWithAncestorCounts struct_many_sigops{package_child_sigops};
        struct_many_sigops.ancestor_counts.resize(package_child_sigops.size());
        BOOST_CHECK_EQUAL(*PackageV3Checks(tx_many_sigops, total_sigops * DEFAULT_BYTES_PER_SIGOP / WITNESS_SCALE_FACTOR, struct_many_sigops, empty_ancestors),
                          expected_error_str);
    }
    ...
    auto tx_mempool_v3_child = make_tx({COutPoint{mempool_tx_v3->GetHash(), 0}}, /*version=*/3);
    {
        ...
        PackageWithAncestorCounts struct_v3_1p1c{package_v3_1p1c};
        struct_v3_1p1c.ancestor_counts.resize(package_v3_1p1c.size());
        BOOST_CHECK(PackageV3Checks(tx_mempool_v3_child, GetVirtualTransactionSize(*tx_mempool_v3_child), struct_v3_1p1c, empty_ancestors) == std::nullopt);
    }
    ...
    // Configuration where tx has multiple direct children.
    {
        ...
        BOOST_CHECK_EQUAL(*ApplyV3Rules(tx_v3_child2, *ancestors, empty_conflicts_set, GetVirtualTransactionSize(*tx_v3_child2)),
                          expected_error_str);
        ...
        PackageWithAncestorCounts struct_v3_1p2c{package_v3_1p2c};
        struct_v3_1p2c.ancestor_counts.resize(package_v3_1p2c.size());
        BOOST_CHECK_EQUAL(*PackageV3Checks(tx_v3_child2, GetVirtualTransactionSize(*tx_v3_child2), struct_v3_1p2c, empty_ancestors),
                          expected_error_str);
    }
