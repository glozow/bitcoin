...
BOOST_FIXTURE_TEST_CASE(package_validation_tests, TestChain100Setup)
{
    ...
    // Error string for CheckPackageMempoolAcceptResult
    std::string str;
    ...
    BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({tx_parent, tx_child}, result_parent_child, /*expect_valid=*/true, nullptr, str), str);
    ...
    BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({giant_ptx}, result_single_large, /*expect_valid=*/false, nullptr, str), str);
...
BOOST_FIXTURE_TEST_CASE(package_submission_tests, TestChain100Setup)
{
    ...
    // missing inputs, so the package validation isn't expected to happen.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({tx_parent_invalid, tx_child}, result_quit_early, /*expect_valid=*/false, m_node.mempool.get(), str), str);
    ...
    // Submit package parent + child + grandchild.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_3gen, result_3gen_submit, /*expect_valid=*/true, m_node.mempool.get(), str), str);
    ...
    // Already-in-mempool transactions should be detected and de-duplicated.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_parent_child, submit_deduped, /*expect_valid=*/true, m_node.mempool.get(), str), str);
    ...
    // do not allow parents to pay for children
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_ppfc, result_ppfc, /*expect_valid=*/false, m_node.mempool.get(), str), str);
...
BOOST_FIXTURE_TEST_CASE(package_witness_swap_tests, TestChain100Setup)
{
    ...
    // same-txid-different-witness.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({ptx_parent, ptx_child1}, submit_witness1, /*expect_valid=*/true, m_node.mempool.get(), str), str);

        // Child2 would have been validated individually.
        const auto submit_witness2 = ProcessNewPackage(m_node.chainman->ActiveChainstate(), *m_node.mempool,
                                                       {ptx_parent, ptx_child2}, /*test_accept=*/false);
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({ptx_parent, ptx_child2}, submit_witness2, /*expect_valid=*/true, m_node.mempool.get(), str), str);
        ...
        const auto submit_segwit_dedup = ProcessNewPackage(m_node.chainman->ActiveChainstate(), *m_node.mempool,
                                                           {ptx_parent, ptx_child1}, /*test_accept=*/false);
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({ptx_parent, ptx_child1}, submit_segwit_dedup, /*expect_valid=*/true, m_node.mempool.get(), str), str);
    ...
    // We already submitted child1 above.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult({ptx_child2, ptx_grandchild}, submit_spend_ignored, /*expect_valid=*/true, m_node.mempool.get(), str), str);
    ...
    // child should be accepted
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_mixed, mixed_result, /*expect_valid=*/true, m_node.mempool.get(), str), str);
...
BOOST_FIXTURE_TEST_CASE(package_cpfp_tests, TestChain100Setup)
{
    ...
    m_node.mempool->PrioritiseTransaction(tx_parent->GetHash(), child_value - coinbase_value);
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_cpfp, submit_cpfp_deprio, /*expect_valid=*/false, m_node.mempool.get(), str), str);
    ...
    // child pays enough for the package feerate to meet the threshold.
    {
        ...
        const auto submit_cpfp = ProcessNewPackage(m_node.chainman->ActiveChainstate(), *m_node.mempool,
                                                   package_cpfp, /*test_accept=*/ false);
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_cpfp, submit_cpfp, /*expect_valid=*/true, m_node.mempool.get(), str), str);
    ...
    // Cheap package should fail for being too low fee.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_still_too_low, submit_package_too_low, /*expect_valid=*/false, m_node.mempool.get(), str), str);
    ...
    // Now that the child's fees have "increased" by 1 BTC, the cheap package should succeed.
    {
        const auto submit_prioritised_package = ProcessNewPackage(m_node.chainman->ActiveChainstate(), *m_node.mempool,
                                                                  package_still_too_low, /*test_accept=*/false);
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_still_too_low, submit_prioritised_package, /*expect_valid=*/true, m_node.mempool.get(), str), str);
        expected_pool_size += 2;
    ...
    // The correct behavior is to accept Parent1 and Parent2, but not the child.
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_parent_pfp, submit_parent_pfp, /*expect_valid=*/false, m_node.mempool.get(), str), str);
        expected_pool_size += 2;
...
BOOST_FIXTURE_TEST_CASE(linearization_tests, TestChain100Setup)
{
    ...
    const CAmount coinbase_value{50 * COIN};
    {
        ...
        BOOST_CHECK_MESSAGE(CheckPackageMempoolAcceptResult(package_desc_limits, result_desc_limits, /*expect_valid=*/false, m_node.mempool.get(), str), str);
