...
void CBlockPolicyEstimator::TransactionAddedToMempool(const CTransactionRef& ptx,
                                                      const TxMempoolInfo& txinfo,
                                                      uint64_t mempool_sequence)
{
    AssertLockNotHeld(m_cs_fee_estimator);
    unsigned int txHeight = txinfo.entry_height;
    uint256 hash = txinfo.tx->GetHash();
    ...
    CFeeRate feeRate(txinfo.fee, txinfo.vsize);
