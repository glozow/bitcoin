...
public:
    ...
    std::optional<std::vector<CTransactionRef>> GetAncestorSet(const CTransactionRef& tx) const;
    ...
    std::optional<std::pair<CAmount, int64_t>> GetAncestorFeeAndVsize(const CTransactionRef& tx) const;
