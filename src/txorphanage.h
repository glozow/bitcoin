...
public:
    ...
    /** Get all children+fromPeer of this parent. */
    std::vector<std::pair<CTransactionRef, NodeId>> GetChildren(const CTransactionRef& parent) const EXCLUSIVE_LOCKS_REQUIRED(!m_mutex);
