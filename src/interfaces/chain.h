...
public:
    ...
    //! Calculate the in-mempool ancestors for a given transaction, referenced by txid.
    virtual std::optional<std::vector<CTransactionRef>> getAncestors(const CTransactionRef& txid);
