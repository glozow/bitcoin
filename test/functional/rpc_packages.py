...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_independent(self):
        ...
        testres_bad = testres_independent_ids + [{"txid": tx.rehash(), "wtxid": tx.getwtxid(), "allowed": False, "reject-reason": "missing-inputs"}]
        ...
        package_high_fee = self.independent_txns_hex + [tx_high_fee_signed["hex"]]
        self.assert_testres_equal(package_high_fee, self.independent_txns_testres + testres_high_fee)
    ...
    def test_rbf(self):
        ...
        testres_rbf_package = [{"txid": res["txid"], "wtxid": res["wtxid"]} for res in self.independent_txns_testres] + [{
