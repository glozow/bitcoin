...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_chain(self):
        ...
        assert_equal(testres_multiple_unsorted, [{"txid": tx.rehash(), "wtxid": tx.getwtxid()} for tx in chain_txns[::-1]])
    ...
    def test_multiple_parents(self):
        ...
        self.log.info("Testmempoolaccept a package in which a transaction has two parents within the package")
        # Parent A
    ...
    def test_rbf(self):
        ...
        self.log.info("Test that packges cannot conflict with mempool transactions, even if a valid BIP125 RBF")
