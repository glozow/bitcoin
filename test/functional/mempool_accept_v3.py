...
class MempoolAcceptV3(BitcoinTestFramework):
    ...
    def test_v3_ancestors_package(self):
        ...
        assert all([txresult["package-error"] == "v3-violation" for txresult in result])
    ...
    def test_v3_ancestors_package_and_mempool(self):
        ...
        assert_equal(result['package_msg'], f"v3-violation, tx {tx_child_violator['wtxid']} would have too many ancestors")
        self.check_mempool([tx_in_mempool["txid"]])
